...
void loop()
{
  scrollStep = 1; sx = 1;  sy = 1; scrollDelay = 10; offsY = (128-rFont->ht*sy)/2;
  //scrollString("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+-!?.: ");
  scrollString("This is an example of super-smooth scrolling with ordinary Arduino, ILI9163C 128x128 LCD library and large RRE font ...    ");
}
