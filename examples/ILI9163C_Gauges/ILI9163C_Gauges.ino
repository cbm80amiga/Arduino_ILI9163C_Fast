...
void drawEqBars()
{
  for(int i=0;i<16;i++) {
    ...
    int k=barLev[i];
    if(k<30) k=30; else
    if(k>100) k=127; else k=30+(127-30)*(k-30)/(100-30);
    lcd.fillRect(i*8,127-barLev[i],7,barLev[i],RGBto565(r*k/127,g*k/127,b*k/127));
  ...
  int r=random(16);
  barLevSet[r]=random(10,128); barDec[r]=0;
